...
if os.path.exists("/opt/spark/conf/gcp-key.json"):
    key_path = "/opt/spark/conf/gcp-key.json" # Docker
elif os.path.exists("service-account.json"):
    key_path = "service-account.json"        # Local host
else:
...
spark = SparkSession.builder \
    ...
    .config("spark.hadoop.fs.gs.storage.http.transport.type", "GRPC")\
